    ...
    return (
        <>
            ...
            <div className="p-2 md:p-0 md:mycontainer mt-5 min-h-[78.11vh]">
                ...
                <p className=' text-lg text-center pt-2 text-purple-900'>Safeguarding Your Precious Information Securely</p>

                <div className='text-black flex md:mx-40 flex-col p-4 px-4 gap-6 items-center'>
                    ...
                    <div className='flex flex-col md:flex-row w-full gap-6'>
                        ...
                        <input onChange={handleChange} value={form.username} placeholder='Enter Username' className='rounded-full border border-purple-800 w-[100%] md:w-[50%] py-1 px-4' type="text" name="username" id="2" />

                        <div className=' relative md:w-[50%] '>

                            <input ref={passwordRef} onChange={handleChange} value={form.password} placeholder='Enter Password' className=' w-[100%] rounded-full border border-purple-800  py-1 px-4' type="password" name="password" id="3" />

                            <span onClick={showPassword} className=' cursor-pointer absolute right-0'><img ref={ref} className=' px-2 pt-[5px]' src="icons/eye.svg" alt="eye" /></span>
                ...
                <div className="passwords px-200 md:mx-44    ">
